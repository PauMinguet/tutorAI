      ...
      <main className="flex flex-col items-center justify-center py-2 text-center flex-grow">
        <div className="z-10 max-w-5xl w-full p-6 bg-gray-800 rounded-xl shadow-md space-y-4">
          ...
          <p className="text-lg font-medium">
            This is a tool that helps you generate answers to queries using the
            sources provided. You can upload a PDF, enter a query, and get a
            personalized answer generated by tutorAI. It works best with school
            materials, such as textbooks, slideshows, and research papers. Give
            it a try and see how it can help you with your studies!
          </p>
